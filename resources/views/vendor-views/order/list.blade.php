            ...
            <div class="row align-items-center mb-3">
                <div class="col-sm">
                    <h1 class="page-header-title text-capitalize">{{ str_replace('_', ' ', $status) }}
                        {{ __('messages.orders') }} <span class="badge badge-soft-dark ml-2">{{ $orders->total() }} </span>
                    </h1>
                </div>
            </div>
        </div>
                        ...
                        <div class="d-sm-flex justify-content-sm-end align-items-sm-center">
                            ...
                            <div class="hs-unfold mr-2">
                                ...
                                <div id="usersExportDropdown"
                                    ...
                                    <span class="dropdown-header">{{ __('messages.download') }}
                                        {{ __('messages.options') }}</span>
                                ...
                                <div id="showHideDropdown"
                                    ...
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <span class="mr-2 text-capitalize">{{ __('messages.payment') }}
