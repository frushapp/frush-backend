    ...
    <main id="content" role="main" class="main">
        ...
        <div class="container py-5 py-sm-7">
            <a class="d-flex justify-content-center mb-5" href="javascript:">
                <img class="z-index-2" src="{{ asset('public/assets/admin/img/logo_sfd.png') }}" alt="Image Description"
                    ...
                    <div class="card card-lg mb-5">
                        <div class="card-body">
                            <div class="text-center">
                                <div class="mb-5">
                                    <h1 class="display-4">{{ __('messages.restaurant') }} {{ __('messages.sign_in') }}
                                    </h1>
                            ...
                            <form class="login_form" action="{{ route('vendor.auth.login') }}" method="post"
                                ...
                                <div class="text-center">
                                    <div class="m-2">
                                        <span
                                            class="divider text-muted m-4">{{ __('messages.restaurant_owner_login_form') }}</span>
                                    </div>
                                </div>
                                <div class="js-form-message form-group">
                                    <label class="input-label"
                                        for="signinSrEmail">{{ __('messages.your_email') }}</label>
                                    ...
                                    <div class="row p-2">
                                        <div class="col-6 pr-0">
                                            <input type="text" class="form-control form-control-lg"
                                                ...
                                                placeholder="{{ \__('Enter recaptcha value') }}" style="border: none"
                                                autocomplete="off"
                            ...
                            <!-- End Form -->
                            <!-- Form -->
                            <form class="login_form" action="{{ route('vendor.auth.employee.login') }}"
                                method="post" id="employee_login_form" style="display: none;">
                                @csrf
                                <div class="text-center">
                                    <div class="m-2">
                                        <span class="divider text-muted m-4">
                                            {{ __('messages.restaurant_employee_login_form') }}
                                        </span>
                                    </div>
                                ...
                                @else
                                    <div class="row p-2">
                                        <div class="col-6 pr-0">
                                            <input type="text" class="form-control form-control-lg"
                                                name="custome_recaptcha2" id="custome_recaptcha2" required
                                                placeholder="{{ \__('Enter recaptcha value') }}" style="border: none"
                                                autocomplete="off"
                                                value="{{ env('APP_DEBUG') ? session('six_captcha') : '' }}">
                                        </div>
                                ...
                                <button type="submit"
                                    class="btn btn-lg btn-block btn-primary">{{ __('messages.sine_in') }}</button>
                            ...
                            <!-- End Form -->
                            <div class="text-center">
                                <button class="btn btn-lg btn-block btn-white mb-4" type="button"
                                    id="owner_sign_in">
                        ...
                        @if (env('APP_MODE') == 'demo')
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-10">
                                        <span class="badge badge-soft-info">Restaurant Owner login
                                            credential.</span><br>
