    ...
    <main id="content" role="main" class="main">
        ...
        <div class="container py-5 py-sm-7">
            ...
            <a class="d-flex justify-content-center mb-5" href="javascript:">
                <img class="z-index-2" onerror="this.src='{{ asset('public/assets/admin/img/logo_sfd.png') }}'"
                            ...
                            <form class="" action="{{ route('admin.auth.login') }}" method="post"
                                ...
                                <div class="text-center">
                                    <div class="mb-5">
                                        ...
                                        <span class="badge badge-soft-info">(
                                            {{ __('messages.admin_or_employee_signin') }} )</span>
                                        <p>{{ __('messages.want') }} {{ __('messages.to') }}
                                            {{ __('messages.login') }} {{ __('messages.your') }}
                                            {{ __('messages.vendors') }}?
                                ...
                                <div class="js-form-message form-group">
                                    <label class="input-label text-capitalize"
                                        for="signinSrEmail">{{ __('messages.your') }}
                                ...
                                <div class="js-form-message form-group">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="password" class="js-toggle-password form-control form-control-lg"
                                            ...
                                            aria-label="{{ __('messages.password_length_placeholder', ['length' => '6+']) }}"
                                ...
                                <button type="submit"
                                    class="btn btn-lg btn-block btn-primary">{{ __('messages.sign_in') }}</button>
                            </form>
                            <!-- End Form -->
                        </div>
