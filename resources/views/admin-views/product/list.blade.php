                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label class="toggle-switch toggle-switch-sm"
                                                ...
                                                <input type="checkbox"
                                                    onclick="location.href='{{ route('admin.food.status', [$food['id'], $food->status ? 0 : 1]) }}'"class="toggle-switch-input"
                                        ...
                                        <td>
                                            <form action="{{ route('admin.food.update_food', ['id' => $food->id]) }}"
                                                method="POST" id="formpopular-{{ $food->id }}">
                                                @csrf
                                                @method('PUT')
                                                <input type="hidden" name="is_popular"
                                                    value="{{ $food->is_popular === '1' ? '0' : '1' }}">
                                                <label class="toggle-switch toggle-switch-sm"
                                                    for="popularstocksCheckbox{{ $food->id }}">
                                                    <input type="checkbox" class="toggle-switch-input"
                                                        id="popularstocksCheckbox{{ $food->id }}" name="is_popular"
                                                        value="{{ $food->is_popular === '1' ? '0' : '1' }}"
                                                        {{ $food->is_popular == '1' ? 'checked' : '' }}
                                        ...
                                        <td>
                                            <form action="{{ route('admin.food.update_food', ['id' => $food->id]) }}"
                                                method="POST" id="formisactive-{{ $food->id }}">
                                                @csrf
                                                @method('PUT')
                                                <input type="hidden" name="is_trending"
                                                    value="{{ $food->is_trending === '1' ? '0' : '1' }}">
                                                <label class="toggle-switch toggle-switch-sm"
                                                    for="trending_stocksCheckbox{{ $food->id }}">
                                                    <input type="checkbox" class="toggle-switch-input"
                                                        id="trending_stocksCheckbox{{ $food->id }}"
                                                        name="is_trending"
                                                        value="{{ $food->is_trending == '1' ? '0' : '1' }}"
