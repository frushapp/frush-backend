                        ...
                        <div class="card p-4" id="{{ $default_lang }}-form">
                            <div class="form-group">
                                ...
                                <input type="text" name="name[]" class="form-control"
                                    placeholder="{{ __('messages.new_food') }}" value="{{ $product['name'] }}" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="veg" class="form-control js-select2-custom">
                                    <option value="0" {{ $product['veg'] == 0 ? 'selected' : '' }}>
                                        {{ __('messages.non_veg') }}</option>
                                    <option value="1" {{ $product['veg'] == 1 ? 'selected' : '' }}>
                                        {{ __('messages.veg') }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-3 col-6">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            @if (count(json_decode($product['add_ons'], true)) > 0)
                getRestaurantData(
                    '{{ url('/') }}/admin/vendor/get-addons?@foreach (json_decode($product['add_ons'], true) as $addon)data[]={{ $addon }}& @endforeach restaurant_id=',
                    '{{ $product['restaurant_id'] }}', 'add_on');
            @else
                getRestaurantData('{{ url('/') }}/admin/vendor/get-addons?data[]=0&restaurant_id=',
                    '{{ $product['restaurant_id'] }}', 'add_on');
            @endif
        });
    </script>
