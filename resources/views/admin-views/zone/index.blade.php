...
@section('content')
    <div class="content container-fluid">
                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <a href="{{ route('admin.zone.create') }}">
                        <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{ __('messages.add') }}
                            {{ __('messages.new') }} {{ __('messages.zone') }}
                        </h1>
                    </a>
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 d-none col-lg-12 mb-3 mb-lg-2">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control"
                                    placeholder="{{ __('messages.new_zone') }}" value="{{ old('name') }}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">Coordinates<span
                                        ...
                                        title="{{ __('messages.draw_your_zone_on_the_map') }}">{{ __('messages.draw_your_zone_on_the_map') }}</span></label>
            ...
            <div class="col-sm-12 col-lg-12 mb-3 my-lg-2">
                <div class="card">
                    <div class="card-header">
                        <h5>{{ __('messages.zone') }} {{ __('messages.list') }}<span class="badge badge-soft-dark ml-2"
                                id="itemCount">{{ $zones->total() }}</span></h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-white"
                                                ...
                                                title="{{ __('messages.edit') }} {{ __('messages.zone') }}"><i
                                                    class="tio-edit"></i>
                                            </a>
