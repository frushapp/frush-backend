            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.coupon.update',[$coupon['id']])}}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-6">
                            <div class="form-group">
                                <label class="input-label" for="discount_type">COD/ONLINE</label>
                                <select name="coupon_type_cod" id="coupon_code_type" class="form-control">
                                    <option value="COD" {{$coupon['coupon_type_cod']=='COD'?'selected':''}}>COD
                                    </option>
                                    <option value="BOTH" {{$coupon['coupon_type_cod']=='BOTH'?'selected':''}}>BOTH
                                    </option>
                                    <option value="ONLINE" {{$coupon['coupon_type_cod']=='ONLINE'?'selected':''}}>
                                        ONLINE
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="col-md-3 col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{$coupon['description']}}"  name="description" class="form-control"
