                            ...
                            <td>
                                <label class="toggle-switch toggle-switch-sm" for="stocksCheckbox{{$customer->id}}">
                                    <?php 
                                        ...
                                        $cod_message =  "" ;
                                        $code_status = "NO";
                                        if($customer->is_cod_available == 'YES'){
                                            $cod_message = "Block COD of this customer";
                                            $code_status = "NO";
                                        } else {
                                            $cod_message = "Un-Block COD of this customer";
                                            $code_status = "YES";
                                        }
                                    ...
                                    <input type="checkbox" 
                                    onclick="cod_status_change_alert('{{route('admin.customer.cod_status',[$customer->id,$code_status])}}', '{{$cod_message}}' , event)" 
                                    class="toggle-switch-input" id="stocksCheckbox{{$customer->id}}" {{$customer->is_cod_available == 'YES'?'checked':''}}>
                                    <span class="toggle-switch-label">
                                        <span class="toggle-switch-indicator"></span>
                                    </span>
                                </label>
...
@push('script_2')
    <script>
        ...
        function cod_status_change_alert(url, message, e) {
            e.preventDefault();
            Swal.fire({
                title: 'Are you sure?',
                text: message,
