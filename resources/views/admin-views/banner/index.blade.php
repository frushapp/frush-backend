            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{ __('messages.add') }}
                        {{ __('messages.new') }} {{ __('messages.banner') }}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control"
                                            placeholder="{{ __('messages.new_banner') }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="input-label"
                                    ...
                                    <div class="form-group">
                                        <label class="input-label"
                                            for="exampleFormControlInput1">{{ __('messages.banner') }}
                                    ...
                                    <div class="form-group" id="item_wise">
                                        <label class="input-label"
                                            for="exampleFormControlInput1">{{ __('messages.select') }}
                                            {{ __('messages.food') }}</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label"
                                                for="customFileEg1">{{ __('messages.choose') }}
                ...
                <div class="card">
                    <div class="card-header">
                        <h5>{{ __('messages.banner') }} {{ __('messages.list') }}<span class="badge badge-soft-dark ml-2"
                                id="itemCount">{{ $banners->count() }}</span></h5>
                        <form id="search-form">
                            @csrf
                            <!-- Search -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-white"
                                                href="{{ route('admin.banner.edit', [$banner['id']]) }}"title="{{ __('messages.edit') }} {{ __('messages.banner') }}"><i
                                                    class="tio-edit"></i>
                                            </a>
