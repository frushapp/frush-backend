        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title text-capitalize">{{ __('messages.business') }} {{ __('messages.setup') }}
                    </h1>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{ route('admin.business-settings.update-setup') }}" method="post"
                        ...
                        <div class="col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <select name="language[]" id="language" data-maximum-selection-length="3"
                                    ...
                                    <option value="ar">Arabic - اية</option>
                                    <option value="an">Aragonese - aragonés</option>
                                    <option value="hy">Armenian - հայերեն</option>
                                    <option value="ast">Asturian - asturianu</option>
                                    <option value="az">Azerbaijani - azərbaycan dili</option>
                                    <option value="eu">Basque - euskara</option>
                                    <option value="be">Belarusian - беларускя</option>
                                    <option value="bn">Bengali - বাংলা</option>
                                    <option value="bs">Bosnian - bosanski</option>
                                    <option value="br">Breton - brezhoneg</option>
                                    <option value="bg">Bulgarian - български</option>
                                    <option value="ca">Catalan - català</option>
                                    <option value="ckb">Central Kurdish - کوردی (دەستنوسی ەەبی)</option>
                                    <option value="zh">Chinese - 中文</option>
                                    <option value="zh-HK">Chinese (Hong Kong) - 中文香港</option>
                                    ...
                                    <option value="ka">Georgian - არულ</option>
                                    <option value="de">German - Deutsch</option>
                                    <option value="de-AT">German (Austria) - Deutsch (Österreich)</option>
                                    <option value="de-DE">German (Germany) - Deutsch (Deutschland)</option>
                                    <option value="de-LI">German (Liechtenstein) - Deutsch (Liechtenstein)</option>
                                    <option value="de-CH">German (Switzerland) - Deutsch (Schweiz)</option>
                                    <option value="el">Greek - Ελληνιά</option>
                                    <option value="gn">Guarani</option>
                                    <option value="gu">Gujarati - ગુજરાતી</option>
                                    <option value="ha">Hausa</option>
                                    <option value="haw">Hawaiian - Ōlelo Hawaiʻi</option>
                                    <option value="he">Hebrew - עברית</option>
                                    <option value="hi">Hindi - हिनदी</option>
                                    ...
                                    <option value="ja">Japanese - 日本</option>
                                    <option value="kn">Kannada - ್ನಡ</option>
                                    <option value="kk">Kazakh - қаза тлі</option>
                                    <option value="km">Khmer - ខ្មែ</option>
                                    <option value="ko">Korean - 한국어</option>
                                    <option value="ku">Kurdish - Kurdî</option>
                                    <option value="ky">Kyrgyz - кыргзча</option>
                                    <option value="lo">Lao - ລາ</option>
                                    <option value="la">Latin</option>
                                    <option value="lv">Latvian - latviešu</option>
                                    <option value="ln">Lingala - lingála</option>
                                    <option value="lt">Lithuanian - lietuvių</option>
                                    <option value="mk">Macedonian - македски</option>
                                    <option value="ms">Malay - Bahasa Melayu</option>
                                    <option value="ml">Malayalam - മാളം</option>
                                    <option value="mt">Maltese - Malti</option>
                                    <option value="mr">Marathi - मराठी</option>
                                    <option value="mn">Mongolian - монгол</option>
                                    <option value="ne">Nepali - नेाली</option>
                                    <option value="no">Norwegian - norsk</option>
                                    <option value="nb">Norwegian Bokmål - norsk bokmål</option>
                                    <option value="nn">Norwegian Nynorsk - nynorsk</option>
                                    <option value="oc">Occitan</option>
                                    <option value="or">Oriya - ଓଡ଼ଆ</option>
                                    ...
                                    <option value="ru">Russian - руский</option>
                                    <option value="gd">Scottish Gaelic</option>
                                    <option value="sr">Serbian - рпски</option>
                                    ...
                                    <option value="es-419">Spanish (Latin America) - español (Latinoamrica)</option>
                                    ...
                                    <option value="ta">Tamil - தழ்</option>
                                    <option value="tt">Tatar</option>
                                    <option value="te">Telugu - లుగు</option>
                                    <option value="th">Thai - ไทย</option>
                                    <option value="ti">Tigrinya - ትግር</option>
                                    <option value="to">Tongan - lea fakatonga</option>
                                    <option value="tr">Turkish - Türkçe</option>
                                    <option value="tk">Turkmen</option>
                                    <option value="tw">Twi</option>
                                    <option value="uk">Ukrainian - укрїнська</option>
                                    <option value="ur">Urdu - ردو</option>
                                    ...
                                    <option value="yo">Yoruba - Èdè Yorb</option>
                            ...
                            <div class="form-group">
                                ...
                                <select name="timezone" class="form-control js-select2-custom">
                                    ...
                                    <option value="Australia/Hobart"
                                        {{ $tz ? ($tz == 'Australia/Hobart' ? 'selected' : '') : '' }}>(GMT+10:00) Hobart
                                    </option>
                                    <option value="Pacific/Guam"
                                        {{ $tz ? ($tz == 'Pacific/Guam' ? 'selected' : '') : '' }}>
                                        (GMT+10:00) Guam, Port Moresby</option>
                                    <option value="Asia/Vladivostok"
                                        {{ $tz ? ($tz == 'Asia/Vladivostok' ? 'selected' : '') : '' }}>(GMT+10:00)
                                        Vladivostok
                                    </option>
                                    ...
                                    <option value="Pacific/Auckland"
                                        {{ $tz ? ($tz == 'Pacific/Auckland' ? 'selected' : '') : '' }}>(GMT+12:00)
                                        Auckland,
                                        Wellington</option>
                                ...
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="canceled_by_restaurant">{{ __('messages.yes') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="canceled_by_restaurant2">{{ __('messages.no') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                                ...
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="canceled_by_deliveryman">{{ __('messages.yes') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="canceled_by_deliveryman2">{{ __('messages.no') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                                ...
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="show_dm_earning">{{ __('messages.yes') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="show_dm_earning2">{{ __('messages.no') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                                ...
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="vnv2">{{ __('messages.off') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                                ...
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="restaurant_self_registration1">{{ __('messages.on') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="restaurant_self_registration2">{{ __('messages.off') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                                ...
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="dm_self_registration1">{{ __('messages.on') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="dm_self_registration2">{{ __('messages.off') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                    ...
                    <div class="row">
                        ...
                        @php($refer = \App\Models\BusinessSetting::where('key', 'first_order_referral_cash_back')->first())
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                <label class="input-label d-inline" for="exampleFormControlInput1">First Order Referral
                                    Cashback</label>
                                <input type="number" value="{{ $refer->value ?? '' }}"
                                    name="first_order_referral_cash_back" class="form-control" placeholder="" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <!--@php($delivery_charges_slab = \App\Models\BusinessSetting::where('key', 'delivery_charges_slab')->first())-->

                    <!--<?php foreach(json_decode($delivery_charges_slab->value) as $row){ ?>-->
