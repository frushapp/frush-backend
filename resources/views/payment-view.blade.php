                        ...
                        <div class="col-md-6 mb-4" style="cursor: pointer">
                            <div class="card">
                                <div class="card-body pt-1" style="height: 70px">
                                    @php($config=\App\CentralLogics\Helpers::get_business_settings('razor_pay'))
                                    @php($order=\App\Models\Order::find(session('order_id')))
                                    <form id="paymentForm" action="{!!route('payment-razor',['order_id'=>$order['id']])!!}" method="POST">
                                    @csrf
                                    ...
                                    <button class="btn btn-block click-if-alone" id="rzp-button1" type="button"
                                    ...
                                    <!--<button class="btn btn-block " id="rzp-button1" type="button"-->
                                    <!--        >-->
                                    <!--    <img width="100"-->
                                    <!--         src="{{asset('public/assets/admin/img/razorpay.png')}}"/>-->
                                    <!--</button>-->
...
// <script>
    ...
    //         "currency": "{{ \App\CentralLogics\Helpers::currency_code() }}",
    //         "name": "{{\App\Models\BusinessSetting::where(['key'=>'business_name'])->first()->value}}",
    //         "description": "Order #{{$order['id']}}",
    //         "image": "{{asset('storage/app/public/business/'.\App\Models\BusinessSetting::where(['key'=>'logo'])->first()->value)}}",
    //         "prefill": {
    ...
    //         "modal": {
    //             "ondismiss": function(){
    //                 console.log("Checkout form closed without completing the payment");
    //             }
    //         }
    //     };
