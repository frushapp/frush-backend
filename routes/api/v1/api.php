...
Route::group(['namespace' => 'Api\V1', 'middleware' => 'localization'], function () {
    ...
    Route::group(['prefix' => 'products'], function () {
        ...
        Route::get('/stock-cron', 'ProductController@stock_cron');
    ...
    Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
        ...
        Route::post('update-referral-code', 'CustomerController@update_referral_code');
        ...
        Route::group(['prefix' => 'wallet'], function () {
            ...
            Route::post('transactions', 'WalletController@createTransaction');
        });
        ...
        Route::group(['prefix' => 'order'], function () {
            ...
            //shaun
            Route::put("before_cancel_order", 'OrderController@before_cancel_order');
            //shaun
