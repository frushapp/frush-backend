...
class Helpers
{
    public static function send_text_message($phone, $otp)
    {
        ...
        //     return false;
        // }
        $url = "https://www.fast2sms.com/dev/bulkV2?authorization=62xKqTGdDbDXoIdiXLln7zxn2Ajt6AMw4sE9A4tdfjgQOK76kR3pwwXdyhp9&route=dlt&sender_id=FRUSH&message=202174&variables_values={$otp}&flash=0&numbers={$phone}";
    ...
    public static function get_language_name($key)
    {
        $languages = array(
            ...
            "bs" => "Bosnian - bosanski",
            "br" => "Breton - brezhoneg",
            "bg" => "Bulgarian - блгарски",
            "ca" => "Catalan - català",
            "ckb" => "Central Kurdish - کوردی (ەستنوسی عربی)",
            "zh" => "Chinese - 文",
            "zh-HK" => "Chinese (Hong Kong) - 文港）",
            "zh-CN" => "Chinese (Simplified) - 中文（简体）",
            "zh-TW" => "Chinese (Traditional) - （繁體）",
            "co" => "Corsican",
            ...
            "tk" => "Turkmen",
            "tw" => "Twi",
            "uk" => "Ukrainian - укрїнська",
            "ur" => "Urdu - ارو",
            "ug" => "Uyghur",
            "uz" => "Uzbek - ozbek",
            "vi" => "Vietnamese - Tiếng Vit",
            "wa" => "Walloon - wa",
            "cy" => "Welsh - Cymraeg",
            "fy" => "Western Frisian",
            "xh" => "Xhosa",
