...
class OrderController extends Controller
{
    public function list($status, Request $request)
    {
        ...
        $orders = Order::with(['customer', 'restaurant' , "delivery_man:id,f_name,l_name,phone"])
    ...
    public function status(Request $request)
    {
        ...
        if ($request->order_status == 'delivered') {
            ...
            $this->send_sms(json_decode($order["delivery_address"])->contact_person_number , 
                json_decode($order["delivery_address"])->contact_person_name , 
                $request->id , "Delivered" ,"" , "65b261d0d6fc051d2670ec93" );
        ...
        else if($request->order_status == 'canceled')
        {
            ...
            $this->send_sms(json_decode($order["delivery_address"])->contact_person_number , 
                json_decode($order["delivery_address"])->contact_person_name , 
                $request->id , "Cancelled" ,"" , "65b261d0d6fc051d2670ec93" );
    ...
    function send_sms($cphone,$name , $order_id , $restaurant , $amt , $template_id = "6573201bd6fc051a575ed403"){
