...
class ConfigController extends Controller
{
    ...
    public function configuration()
    {
        ...
        return response()->json([
            ...
            'popular_food' => (double)$settings['popular_food'],
            'popular_restaurant' => (double)$settings['popular_restaurant'],
            'new_restaurant' => (double)$settings['new_restaurant'],
            'most_reviewed_foods' => (double)$settings['most_reviewed_foods'],
            'show_dm_earning' => (boolean)$settings['show_dm_earning'],
            'canceled_by_deliveryman' => (boolean)$settings['canceled_by_deliveryman'],
            'canceled_by_restaurant' => (boolean)$settings['canceled_by_restaurant'],
            ...
            'toggle_restaurant_registration' => (boolean)$settings['toggle_restaurant_registration'],
            ...
            //shaun
            'delivery_charges_slab' => $delivery_charges_slab,
            //shaun
